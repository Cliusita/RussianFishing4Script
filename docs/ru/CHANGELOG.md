## 0.11.0 (2026-05-21)
### 🆕 Новые функции
- Добавлена настройка `BOT.CATCH_SCREEN_STYLE`, позволяющая выбрать, нужно ли ожидать возможную анимацию трофея/редкого трофея.

### 🔧 Улучшения
- Улучшение UI/UX

### 🐛 Исправления ошибок
- Исправлена ошибка, из-за которой бот выбрасывал редких трофейных рыб при включении опции `-t`.

### 🗃️ Устаревшие параметры
- Флаг `-NA` помечен как устаревший.
